...
def show_charts(num_chart):
    if num_chart == 1:
        ...
        plt.scatter(vertex_count, d2_heap_res, color="b",  label="3-куча")
        plt.scatter(vertex_count, d3_heap_res, c="r", label="15-куча")
        ...
        with open('case_1b_result.txt', 'r') as input_file:
            ...
            for line in input_file:
                ...
                d3_heap_res.append(float(line.split()[1]))
                vertex_count.append(int(line.split()[2]))
        plt.scatter(vertex_count, d2_heap_res, color="b", linestyle="o",  label="3-куча")
        plt.scatter(vertex_count, d3_heap_res, "ro", label="15-куча")
        plt.xlabel('Количество вершин')
        plt.ylabel('Время')
        ...
        with open('case_2a_result.txt', 'r') as input_file:
            ...
            for line in input_file:
                ...
                d3_heap_res.append(float(line.split()[1]))
                vertex_count.append(int(line.split()[2]))
        plt.scatter(vertex_count, d2_heap_res, c="b", label="3-куча")
        plt.scatter(vertex_count, d3_heap_res, c="r", label="15-куча")
        plt.xlabel('Количество вершин')
        plt.ylabel('Время')
        ...
        plt.scatter(edges_count, d2_heap_res, c="b", label="3-куча")
        plt.scatter(edges_count, d3_heap_res, c="r", label="15-куча")
        ...
        plt.scatter(weight, d2_heap_res, c="b", label="3-куча")
        plt.scatter(weight, d3_heap_res, c="r", label="15-куча")
...
if __name__ == "__main__":
    ...
    window.title("Результаты работы алгоритма Дейкстры на 2,15-кучах")
